...
import userregistration.userregistration.repository.RoleRepository;
import userregistration.userregistration.repository.UserLoginRepository;
import userregistration.userregistration.repository.UserLoginRoleMpgRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		List<UserLoginRoleMpg> userDetailsList = userLoginRoleMpgRepository.findbyUserLoginDtl(user.getUserDetails().getUserId());
		
		Set<Role> role = new HashSet<>();
		
		userDetailsList.forEach(userRoleMapping ->{
			
			Optional<Role> roleData =roleRepository.findById(userRoleMapping.getRoleId());	
